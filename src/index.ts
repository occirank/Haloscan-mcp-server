...
async function makeHaloscanRequest(endpoint: string, params: Record<string, any> = {}, method: "GET" | "POST", apiKey: string): Promise<any> {
...
export function configureHaloscan(server: McpServer) {
